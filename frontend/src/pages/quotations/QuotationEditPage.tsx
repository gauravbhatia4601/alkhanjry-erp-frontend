...
export default function QuotationEditPage() {
  ...
  const [validUntil, setValidUntil] = useState("2026-04-28");
  ...
  return (
    <>
      <PageBreadcrumb pageTitle={`Edit Quotation #${id}`} items={[{ label: "Sales" }, { label: "Quotations", href: `${prefix}/quotations` }, { label: `Edit #${id}` }]} />
          ...
          <ComponentCard title="Quotation Details">
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button className="w-full">Update Quotation</Button>
